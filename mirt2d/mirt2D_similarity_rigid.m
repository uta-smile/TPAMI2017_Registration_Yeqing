...
%         f = f/ON;
%         end
    [f,dd,imsmall] = run_ssd_(imsmall,main);
...
%         f = f/ON;
%         end
        [f,dd,imsmall] = run_rc_(imsmall,main);
...
%         f = f/ON;
%         end
        [f,dd,imsmall] = run_dtv_(imsmall,main);
    otherwise
...
function [f,dd,imsmall] = run_ssd_(imsmall,main)
dd=imsmall-main.refimsmall;
f=nansum(dd(:).^2)/2;
...
function [f,dd,imsmall] = run_rc_(imsmall,main)
rbig=imsmall-main.refimsmall;
...
function [f,dd,imsmall] = run_dtv_(imsmall,main)
rbig=imsmall-main.refimsmall;
[y,x]=find_imagebox(rbig); r=rbig(y,x);
r(isnan(r))=nanmean(r(:));
